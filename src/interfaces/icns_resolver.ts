...
export interface ICNSResolver {
  ...
  'getHost' : (arg_0: string) => Promise<
      [] | [{ 'url' : string } | { 'canister' : Principal }]
    >,
  ...
  'setAddr' : (arg_0: string, arg_1: string, arg_2: [] | [string]) => Promise<
      Result
    >,
  'setCanister' : (
      arg_0: string,
  ...
  'setText' : (arg_0: string, arg_1: string, arg_2: [] | [string]) => Promise<
      Result
    >,
}
