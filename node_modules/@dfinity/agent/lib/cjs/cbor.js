...
class BigIntEncoder {
    ...
    encode(v) {
        ...
        if (v > BigInt(0)) {
            ...
            return cbor.value.tagged(3, cbor.value.bytes(types_1.blobFromHex((BigInt('-1') * v).toString(16))));
        }
    }
}
