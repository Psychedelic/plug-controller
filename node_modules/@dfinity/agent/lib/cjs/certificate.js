...
exports.lookup_path = exports.lookupPathEx = exports.reconstruct = exports.Certificate = exports.hashTreeToString = void 0;
...
function hashTreeToString(tree) {
    ...
    switch (tree[0]) {
        ...
        case 4: {
            return `pruned(${types_1.blobToHex(types_1.blobFromUint8Array(new Uint8Array(tree[1])))}`;
        }
        default: {
...
function lookupPathEx(path, tree) {
    const maybeReturn = lookup_path(path.map(p => {
        if (typeof p === 'string') {
            return types_1.blobFromText(p);
        }
        else {
            return types_1.blobFromUint8Array(new Uint8Array(p));
        }
    }), tree);
    return maybeReturn && types_1.blobToUint8Array(types_1.blobFromBuffer(maybeReturn));
}
